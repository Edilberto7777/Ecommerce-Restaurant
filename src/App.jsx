...
export function AdminProvider({ children }) {
  ...
  return <AdminContext.Provider value={{ adminLoggueada, setAdminLoggueada }}>{children}</AdminContext.Provider>;
}
  ...
  return (
    <AnimatePresence mode="sync">
      <Routes location={location} key={location.pathname}>
        <Route path="/" element={<Layout usuario={usuario} telefono={telefono} municipioActivo={municipioActivo} contador={contador} precioMensajeria={precioMensajeria} />} />
        ...
        <Route
          ...
          element={
            <Formulario
              ...
              setMunicipioActivo={setMunicipioActivo}
              contador={contador}
              setContador={setContador}
              precioMensajeria={precioMensajeria}
              setPrecioMensajeria={setPrecioMensajeria}
